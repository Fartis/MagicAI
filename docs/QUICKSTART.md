...
### El historial desaparece al recargar

La beta guarda el historial visual en `localStorage`. El navegador puede bloquearlo en modo privado o por políticas de almacenamiento. Las sesiones del servidor siguen en memoria y se pierden al reiniciar FastAPI.
