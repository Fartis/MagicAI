...
TEST_MODULES = (
    ...
    "tests.language.language_policy_test",
    "tests.conversation.casual_normalization_test",
    ...
    "tests.validation.casual_judge_understanding_test",
    "tests.quality.tactician_conversation_contract_test",
    "tests.quality.tactician_conversation_regression_test",
